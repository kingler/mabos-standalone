...
from core.models.sentence_transformer import SentenceTransformerWrapper
...
class KnowledgeBase(BaseModel):
    ...
    def query_knowledge(self, question: str) -> str:
        """
        Queries the knowledge base to answer a question.
        ...
        """
        prompt = f"Answer the following question based on the knowledge base: {question}"
        return self.llm_manager.get_text_completion(prompt)

    def summarize_document(self, document: str) -> str:
        """
        Summarizes a document using the LLM capabilities.
