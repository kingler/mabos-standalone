...
from core.models.message import ACLMessage, Performative
from core.models.agent.goal import Goal
from core.models.llm_decomposer import LLMDecomposer
from core.services.llm_service import LLMService
from core.services.agent_communication_service import AgentCommunicationService

class LLMAgent(Agent):
    def __init__(self, agent_id: UUID, name: str, api_key: str, llm_service: LLMService, agent_communication_service: AgentCommunicationService):
