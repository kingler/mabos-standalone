...
from core.agents.core_agents.llm_agent import LLMAgent
from core.models.mdd.togaf_adm import TOGAFADM
from core.models.mdd.archimate_model import ArchiMateModel
from app.db.arango_db_client import ArangoDBClient

from core.services.mabos_service import MABOSService
from core.services.erp_service import ERPService
from core.models.erp.erp_models import ERPSystem, FinancialModule, HRModule, CRMModule, SupplyChainModule, InventoryModule, ProjectManagementModule, ManufacturingModule
