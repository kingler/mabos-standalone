...
class OntologyLoader:
    ...
    def get_property_domain_range(self, property_name: str) -> tuple[str, str]:
        """
        Get the domain and range of the given property.

        Args:
            property_name (str): The name of the property.

        Returns:
            tuple[str, str]: A tuple containing the domain and range of the property.
        """
        if not self.onto:
            raise RuntimeError("Ontology not loaded.")
        # Implement the logic to get the domain and range of the property
        # based on the property_name
        return ("Domain1", "Range1")
