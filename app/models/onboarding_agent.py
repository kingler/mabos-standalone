...
from app.core.mas_agents.llm_agent import LLMAgent
from app.core.mdd_mas.togaf_adm import TOGAFADM
from app.core.mdd_mas.archimate_model import ArchiMateModel
from app.db.arango_db_client import ArangoDBClient

from app.services.mabos_service import MABOSService
from services.erp_service import ERPService
from erp_models import ERPSystem, FinancialModule, HRModule, CRMModule, SupplyChainModule, InventoryModule, ProjectManagementModule, ManufacturingModule
